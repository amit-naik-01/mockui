    ...
    <div>
      ...
      >
        <DialogTitle style={{display:"flex",justifyContent:"center"}} id="alert-dialog-title">
          <h2 style={{margin:"5px 0 0 0"}}>Add New User</h2>
        </DialogTitle>
        <DialogContent>
          <form>
             <TextField id="firstName" defaultValue={first_name} onChange={e=>onChange(e)} placeholder="First Name" label="First Name" size="small" style={{margin:"0 0 5px 0"}} autoFocus fullWidth/> 
